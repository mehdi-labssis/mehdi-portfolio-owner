...
export default function Home() {
  return <><SiteHeader/><main>
    ...
    <section className="home-work"><div className="section-heading"><p>Selected work</p><h2>Recent projects</h2><a href="/projects">View all 08 <ArrowUpRight size={16}/></a></div><div className="home-projects">{projects.slice(0,3).map(project => <ProjectCard project={project} key={project.slug}/>)}</div></section>
